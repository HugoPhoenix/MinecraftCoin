...
#if defined(NDEBUG)
# error "MinecraftCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "MinecraftCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 1 * 30;
...
{
    RenameThread("minecraftcoin-loadblk");
